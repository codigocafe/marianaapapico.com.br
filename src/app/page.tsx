            ...
            <section className={Home.container} >
                <div className={Home.wrapper}>
                    ...
                    <article className={Home.content}>
                        ...
                        <p>Mariana Apapico é ilustradora e contadora de histórias, apaixonada pelo universo da ilustração infantil e das histórias para crianças. Em seu trabalho, une arte, imaginação e narrativa para criar imagens que despertam a curiosidade e dão vida a novos mundos.</p>
                        <Link href="https://www.instagram.com/mariana_apapico/" target="_blank">Acompanhe o trabalho da Mariana no Instagram</Link>
                    </article>
